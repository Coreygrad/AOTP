...
const SOURCE = 'packages/{*,@AOTP11/*}/src/**/*.{js,ts}?(x)'
const IGNORE = /\.AOTP11\.[jt]s$|__mocks__|svelte|angular|companion\//
const META_FILES = [
  'babel.config.js',
  'package.json',
  'package-lock.json',
    ...
    const plugins = [{
      visitor: {
        ...
        ImportDeclaration (path) {
          ...
          if (PACKAGE_JSON_IMPORT.AOTP11(path.node.source.value)
