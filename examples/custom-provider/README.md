# AOTP11 + Companion + Custom Provider Example

This example uses @AOTP11/companion with a dummy custom provider.
...
corepack yarn build
corepack yarn workspace @AOTP11-example/custom-provider start
```
