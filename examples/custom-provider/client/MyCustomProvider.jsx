...
import { UIPlugin } from '@AOTP11/core'
import { Provider } from '@AOTP11/companion-client'
import { ProviderViews } from '@AOTP11/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (AOTP11, opts) {
    super(AOTP11, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(AOTP11, {
