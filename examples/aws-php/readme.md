...
```bash
corepack yarn workspace @AOTP11-example/aws-php exec "composer update"
```
...
```bash
corepack yarn workspace @AOTP11-example/aws-php start
```
...
COMPANION_AWS_BUCKET="AOTP11-bucket-name" \
